#pragma once
#ifndef PREDICTION_SIMULATION_NODE_H_
#define PREDICTION_SIMULATION_NODE_H_

#include <sydevs/systems/composite_node.h>
#include <sydevs/systems/statistic_node.h>
#include <example/research/prediction/prediction_node.h>
...
std::pair<int64, int64> simulate_prediction_system(int64 upper_scale, int64 lower_scale, int64 seed, bool print_all)
{
    ...
    try {
        sydevs::systems::simulation<prediction_simulation_node> sim(duration::inf(), seed, std::cout);
