#pragma once
#ifndef DATA_SYSTEMS_H_
#define DATA_SYSTEMS_H_

#include <example/test_systems/data/data_primitives_composite_node.h>
#include <example/test_systems/data/data_structures_composite_node.h>
#include <example/test_systems/data/data_arraynds_composite_node.h>
#include <example/test_systems/data/data_tuples_composite_node.h>
...
void data_systems()
{
    ...
    try {
        sydevs::systems::simulation<data_primitives_composite_node> sim(10_s, 0, std::cout);
    ...
    try {
        sydevs::systems::simulation<data_structures_composite_node> sim(10_s, 0, std::cout);
        sim.top.print_on_event();
        sim.top.A.print_on_event();
        sim.top.A.print_on_elapsed_duration();
        sim.top.A.print_on_planned_duration();
    ...
    try {
        sydevs::systems::simulation<data_arraynds_composite_node> sim(10_s, 0, std::cout);
        sim.top.print_on_event();
        sim.top.A.print_on_event();
        sim.top.A.print_on_elapsed_duration();
        sim.top.A.print_on_planned_duration();
    ...
    try {
        sydevs::systems::simulation<data_tuples_composite_node> sim(10_s, 0, std::cout);
        sim.top.print_on_event();
        sim.top.A.print_on_event();
        sim.top.A.print_on_elapsed_duration();
        sim.top.A.print_on_planned_duration();
