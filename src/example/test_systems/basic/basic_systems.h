#pragma once
#ifndef BASIC_SYSTEMS_H_
#define BASIC_SYSTEMS_H_

#include <example/test_systems/basic/basic_generator_node.h>
#include <example/test_systems/basic/basic_processor_node.h>
#include <example/test_systems/basic/basic_double_processor_node.h>
#include <example/test_systems/basic/basic_generator_double_processor_node.h>
...
void basic_systems()
{
    ...
    try {
        sydevs::systems::simulation<basic_generator_double_processor_node> sim(10_s, 0, std::cout);
