#pragma once
#ifndef SORTING_SYSTEMS_H_
#define SORTING_SYSTEMS_H_

#include <example/test_systems/sorting/sorting_2_node.h>
#include <example/test_systems/sorting/sorting_3_node.h>
#include <example/test_systems/sorting/sorting_4_node.h>
#include <example/test_systems/sorting/sorting_4_test_node.h>
...
void sorting_systems()
{
    ...
    try {
        sydevs::systems::simulation<sorting_4_test_node> sim(0_s, 0, std::cout);
