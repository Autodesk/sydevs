#pragma once
#ifndef TWO_STAGE_QUEUEING_NODE_H_
#define TWO_STAGE_QUEUEING_NODE_H_

#include <example/demo/queueing/queueing_node.h>
#include <example/demo/queueing/plus_node.h>
