...
// closed systems (e.g. queueing_closed_system.h), which allow the nodes to be
// tested. The function node example is tested indirectly through its inclusion
// in the composite node example.
