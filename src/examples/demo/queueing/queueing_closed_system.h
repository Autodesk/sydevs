#pragma once
#ifndef SYDEVS_EXAMPLES_QUEUEING_CLOSED_SYSTEM_H_
#define SYDEVS_EXAMPLES_QUEUEING_CLOSED_SYSTEM_H_
 ...
 */
class queueing_closed_system : public composite_node
{
public:
    // Constructor/Destructor:
    queueing_closed_system(const std::string& node_name, const node_context& external_context);
    virtual ~queueing_closed_system() = default;
...
queueing_closed_system::queueing_closed_system(const std::string& node_name, const node_context& external_context)
